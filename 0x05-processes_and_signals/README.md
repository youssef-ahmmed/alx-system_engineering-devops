...
**6. Stop me if you can**
  * [6-stop_me_if_you_can](./6-stop_me_if_you_can): Bash script that stops [4-to_infinity_and_beyond](./4-to_infinity_and_beyond) process, `kill` and `killall` cannot be used.
